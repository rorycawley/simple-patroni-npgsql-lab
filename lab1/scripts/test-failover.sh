...
# Fault-injection tests for the Lab 1 cluster.
#
...
readonly FENCE_TABLE=lab1_fence
...
run_scenario() {
  ...
  client_stdout="$(mktemp "${TMPDIR:-/tmp}/lab1-failover-out.XXXXXX")"
  client_stderr="$(mktemp "${TMPDIR:-/tmp}/lab1-failover-err.XXXXXX")"
