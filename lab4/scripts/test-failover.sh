...
# Fault-injection tests for the Lab 4 cluster.
#
...
readonly FENCE_TABLE=lab4_fence
...
run_scenario() {
  ...
  client_stdout="$(mktemp "${TMPDIR:-/tmp}/lab4-failover-out.XXXXXX")"
  client_stderr="$(mktemp "${TMPDIR:-/tmp}/lab4-failover-err.XXXXXX")"
