...
| **[Lab 8](../lab8/README.md)** | Can we get the **right data** back? | Perfectly healthy, doing the wrong thing |

Recovery from *loss* here; recovery from a *mistake* there. Lab 4 establishes
that point-in-time recovery works at all, which is what lets Lab 8 use it to
